...
const navigation=useNavigation()
 ...
 {/* ,paddingBottom:10,borderBottomWidth:1,borderColor:"#4e9d91" */}
 {/* <TouchableOpacity style={{marginTop:22,backgroundColor:'red',borderRadius:50}} onPress={()=>{
                navigation.navigate("LostFound" as never)}}>
          <View style={styles.container}>
       <Image style={styles.image} source={online}></Image>
          </View>
          <View style={{backgroundColor:"red",marginTop:30,display:'flex',justifyContent:"center",alignContent:"center"}}>
            <Text>Online</Text>
          </View>
</TouchableOpacity> */}
<TouchableOpacity
...
<TouchableOpacity
  ...
  onPress={() => {
    navigation.navigate("OffLine" as never);
  }}
>
  <View style={styles.container}>
